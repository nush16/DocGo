...
const AppointmentSchema = new mongoose.Schema({
  staff: { type: mongoose.Schema.Types.ObjectId, ref: "Staff" }, // Property for storing the doctor (expects a string)
  type: { type: String, required: true }, // Property for storing the type (expects a string)
  patient: [{ type: mongoose.Schema.Types.ObjectId, ref: "Patient" }], // Property for storing the patient name (expects a string)
