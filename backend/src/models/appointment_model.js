...
const AppointmentSchema = new mongoose.Schema({
  practioner: { type: Schema.ObjectId, ref: "Doctor", required: true }, // Property for storing the doctor (expects a string)
  type: { type: String, required: true }, // Property for storing the type (expects a string)
  patient: { type: Schema.ObjectId, ref: "Patient", required: true }, // Property for storing the patient name (expects a string)
